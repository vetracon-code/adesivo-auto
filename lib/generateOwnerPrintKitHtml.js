      ...
      <div class="assembly-box">
        ...
        <div class="assembly-steps">
          <div class="assembly-step">
            <div class="mini-sign-demo">STAMPA<br>QR<br>CARTELLO</div>
            <strong>1. Plastifica e ritaglia</strong>
            <span>Plastifica il foglio, poi ritaglia il cartello seguendo il contorno esterno.</span>
          </div>
          <div class="assembly-step">
            <div class="mini-cut-lines"></div>
            <strong>2. Taglia le feritoie</strong>
            <span>Apri con attenzione le due feritoie indicate: una sopra e una sotto il corpo centrale.</span>
          </div>
          <div class="assembly-step">
            <div class="mini-visor-demo"></div>
            <strong>3. Inserisci ed esponi</strong>
            <span>Incastra i lembi, inserisci il supporto sull’aletta e orienta il QR verso il parabrezza.</span>
          </div>
        </div>
      </div>
    </section>
