...
function generateOwnerPrintKitHtml({ row, qrDataUrl, qrValue, code, plate }) {
  ...
  const autoVisor = `
<div class="a4-page auto-parking-template-v1">
  <img class="auto-template-bg" src="/templates/owner-print/auto/auto-abbassa-quando-parcheggi.png" alt="Cartello auto abbassa quando parcheggi">
  <div class="auto-template-qr">${qrImg}</div>
</div>`;
  ...
  <main class="page">
    ...
    <section class="instructions-box" id="instructionsBox">
      ...
      <div class="safety-note">
        <strong>Nota importante:</strong> plastifica il foglio prima del ritaglio. Ritaglia il contorno, taglia le feritoie indicate e incastra i lembi nelle aperture. Il QR deve essere rivolto verso il parabrezza. Prima di lasciare il veicolo, controlla dall’esterno che sia ben visibile e leggibile.
      </div>
      ...
      <div class="assembly-box">
        ...
        <div class="assembly-steps">
          ...
          <div class="assembly-step">
            <strong>2. Ritaglia e apri le feritoie</strong>
            <span>Ritaglia il contorno esterno e apri con attenzione le feritoie indicate sopra e sotto il corpo centrale.</span>
          </div>
          <div class="assembly-step">
            <strong>3. Incastra i lembi</strong>
            <span>Unisci i lembi incastrandoli nelle feritoie: il cartello deve scendere correttamente quando abbassi l’aletta.</span>
          </div>
        </div>
