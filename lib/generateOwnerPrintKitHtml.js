  ...
  <main class="page">
    ...
    <section class="instructions-box" id="instructionsBox">
      ...
      <div class="safety-note">
        <strong>Nota importante:</strong> per moto, scooter, bici e uso esterno è consigliata la plastificazione. I modelli da specchietto, cruscotto, aletta o vetro vanno esposti solo quando il veicolo è parcheggiato.
      </div>
    </section>
