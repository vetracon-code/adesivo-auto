...
<script id="FOLLOWME_QR_VERIFIED_SCANNER_OVERLAY_20260529">
(function(){
  "use strict";

  if(window.__followMeQrVerifiedScannerOverlay20260529) return;
  window.__followMeQrVerifiedScannerOverlay20260529 = true;

  function injectStyle(){
    if(document.getElementById("followmeQrVerifiedScannerCss20260529")) return;

    var style = document.createElement("style");
    style.id = "followmeQrVerifiedScannerCss20260529";
    style.textContent = `
      #followmeQrVerifiedOverlay20260529{
        position:fixed;
        inset:0;
        z-index:999999;
        display:flex;
        ...
        padding:22px;
        background:
          radial-gradient(circle at 30% 10%, rgba(52,199,89,.14), transparent 34%),
          radial-gradient(circle at 70% 90%, rgba(10,132,255,.12), transparent 32%),
          rgba(248,250,252,.96);
      ...
      #followmeQrVerifiedOverlay20260529.hide{
        opacity:0;
        pointer-events:none;
      ...
      .fm-qr-verified-shield-20260529{
        ...
        place-items:center;
        background:
          linear-gradient(145deg, rgba(52,199,89,.22), rgba(48,209,88,.08)),
          #ffffff;
        box-shadow:
          0 18px 36px rgba(52,199,89,.18),
          inset 0 0 0 1px rgba(52,199,89,.16);
        font-size:34px;
        position:relative;
        z-index:1;
      ...
      #followmeQrVerifiedBadge20260529.show{
        opacity:1;
        transform:translateX(-50%) translateY(0);
      }

      #followmeQrVerifiedBadge20260529 span:first-child{
        font-size:14px;
      }
      ...
      #followmeQrVerifiedDetail20260529.show{
        opacity:1;
        pointer-events:auto;
        transform:translateX(-50%) translateY(0);
      }

      #followmeQrVerifiedDetail20260529 strong{
        display:block;
        font-size:14px;
        font-weight:950;
        margin-bottom:5px;
      ...
      #followmeQrVerifiedDetail20260529 p{
        margin:0;
        color:#475569;
        font-size:12px;
        line-height:1.38;
  ...
  function makeOverlay(){
    if(document.getElementById("followmeQrVerifiedOverlay20260529")) return;

    var overlay = document.createElement("div");
    overlay.id = "followmeQrVerifiedOverlay20260529";
  ...
  function showBadge(){
    if(!document.getElementById("followmeQrVerifiedBadge20260529")){
      var badge = document.createElement("button");
      badge.id = "followmeQrVerifiedBadge20260529";
      badge.type = "button";
    ...
    if(!document.getElementById("followmeQrVerifiedDetail20260529")){
      var detail = document.createElement("div");
      detail.id = "followmeQrVerifiedDetail20260529";
      detail.innerHTML = `
    ...
    requestAnimationFrame(function(){
      var badge = document.getElementById("followmeQrVerifiedBadge20260529");
      if(badge) badge.classList.add("show");
    });
  }

  function toggleDetail(){
    var d = document.getElementById("followmeQrVerifiedDetail20260529");
    if(!d) return;
